 ...
 * cannot .setError to the status Switch so instead an error is set to an "invisible" EditText.
 */
    ...
    public void toggleSwitch(View view) {
        if (status.isChecked()) {
            ...
            if (contact_list.getSize() == 0) {
                ...
                invisible.setError("No contacts available! Must add borrower to status");
